...
- [GenAIScript](https://microsoft.github.io/genaiscript) - JavaScript-ish script to create prompt, orchestrate LLMs and extract structured output. Integrated in Visual Studio Code.
